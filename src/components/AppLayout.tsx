...
import Footer from './Footer/Footer'; // correct import path
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50">
      ...
      <section className="relative h-96 bg-gradient-to-r from-blue-900 to-blue-700">
        ...
        <div className="relative h-full flex items-center px-4 sm:px-6 lg:px-8">
          <div className="text-white">
            ...
            <p className="text-xl mb-2">Discover premium products crafted for excellence</p>
            <p className="text-lg mb-6 font-semibold">Check out our exclusive sale items!</p>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 my-12">
        <h2 className="text-3xl font-bold mb-6 text-gray-800">On Sale</h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {products.filter(p => p.originalPrice && p.price < p.originalPrice).map(product => (
            <ProductCard
              key={product.id}
              product={product}
